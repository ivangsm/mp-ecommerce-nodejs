...
app.get('/detail', function (req, res) {
    let preference = {
        items: [
            {
                ...
                external_reference: 'ivangio.salazar@gmail.com',
            },
        ],
        external_reference: 'ivangio.salazar@gmail.com',
        payer: {
        ...
        back_urls: {
            success:
                'https://ivangsm-mp-ecommerce-nodejs.herokuapp.com/success',
            pending:
                'https://ivangsm-mp-ecommerce-nodejs.herokuapp.com/pending',
            failure:
                'https://ivangsm-mp-ecommerce-nodejs.herokuapp.com/failed',
        },
        notification_url:
            'https://ivangsm-mp-ecommerce-nodejs.herokuapp.com/webhook',
